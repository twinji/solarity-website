/* This document does not contain comments explaining code as main focues in programming skills have been demonstrated and commented on in other files */
...
function main() {
    ...
    init();
    alert("PLEASE NOTE!\n\nThe Explorer is highly experimental at this stage and contains many bugs.\nThere are many planned and incomplete features, so please use this tool for the information and visualisation it provides.");
    ...
    alert("Use arrow keys for navigation:\n\nUP and DOWN to zoom in and out.\nLEFT and RIGHT to switch between planets.");
    window.requestAnimationFrame(gameLoop, canvas);
}
